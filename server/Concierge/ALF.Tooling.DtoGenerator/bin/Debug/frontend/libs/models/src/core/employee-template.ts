...
export type EmployeeTemplateId = string;

export class EmployeeTemplate {

    static $name = "EmployeeTemplate";
    static typeNameHint = "ALF.Shared.Dto.Models.Core.EmployeeTemplate, ALF.Shared.Dto"
    ...
    constructor(data?: Partial<EmployeeTemplate>) {
