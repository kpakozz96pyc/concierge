...
export class PeriodPlanEditableFields {

    static $name = "PeriodPlanEditableFields";
    static typeNameHint = "ALF.Shared.Dto.Models.Periods.Planning.PeriodPlanEditableFields, ALF.Shared.Dto"
    ...
    constructor(data?: Partial<PeriodPlanEditableFields>) {
