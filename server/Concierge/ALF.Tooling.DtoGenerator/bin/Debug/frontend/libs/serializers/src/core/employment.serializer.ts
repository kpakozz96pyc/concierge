...
import { Employment } from "@alf/models/core/employment";

// ######################################################
// ## NOTE! This is an auto-generated file.            ##
// ######################################################

export class EmploymentSerializer implements Serializer<Employment> {

    deserialize(data: undefined): undefined
    deserialize(data: any): Employment
    deserialize(data: any): Employment | undefined {
        if (!data) {
            return undefined;
        }
        ...
        return new Employment(copy);
    }

    serialize(entity: Employment | undefined, _forceTypeHint?: boolean): any | undefined
    serialize(entity: undefined, _forceTypeHint?: boolean): undefined
    serialize(entity: Employment, _forceTypeHint?: boolean): any
    serialize(entity: Employment | undefined, _forceTypeHint?: boolean): any | undefined {
        if (!entity) {
            return undefined;
        }
        ...
        return {
            $type: _forceTypeHint ? Employment.typeNameHint : undefined,
            id: entity.id,
