...
export class ImportEmployeeFeatureSerializer implements Serializer<ImportEmployeeFeature> {

    deserialize(data: undefined): undefined
    deserialize(data: any): ImportEmployeeFeature
    deserialize(data: any): ImportEmployeeFeature | undefined {
        if (!data) {
            return undefined;
        }
        ...
        return new ImportEmployeeFeature(copy);
    }

    serialize(entity: ImportEmployeeFeature | undefined, _forceTypeHint?: boolean): any | undefined
    serialize(entity: undefined, _forceTypeHint?: boolean): undefined
    serialize(entity: ImportEmployeeFeature, _forceTypeHint?: boolean): any
    serialize(entity: ImportEmployeeFeature | undefined, _forceTypeHint?: boolean): any | undefined {
        if (!entity) {
            return undefined;
        }
