...
import { Employee } from "@alf/models/core/employee";

// ######################################################
// ## NOTE! This is an auto-generated file.            ##
// ######################################################

export class EmployeeSerializer implements Serializer<Employee> {

    deserialize(data: undefined): undefined
    deserialize(data: any): Employee
    deserialize(data: any): Employee | undefined {
        if (!data) {
            return undefined;
        }
    ...
    serialize(entity: Employee | undefined, _forceTypeHint?: boolean): any | undefined
    serialize(entity: undefined, _forceTypeHint?: boolean): undefined
    serialize(entity: Employee, _forceTypeHint?: boolean): any
    serialize(entity: Employee | undefined, _forceTypeHint?: boolean): any | undefined {
        if (!entity) {
            return undefined;
        }
        ...
        return {
            $type: _forceTypeHint ? Employee.typeNameHint : undefined,
            id: entity.id,
            companyId: entity.companyId,
            employeeNumber: entity.employeeNumber,
            employments: entity.employments,
            isSynchronizedWithExternalSystem: entity.isSynchronizedWithExternalSystem,
            name: entity.name,
